...
if (isset($_POST['record_category_btn'])) {
    ...
    $check_query = "SELECT * FROM record_category WHERE route_number = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (!empty($image)) {
            ...
            if (in_array($image_ext, $allowed_extensions)) {
                ...
                $insert_query = "INSERT INTO record_category (route_number, record_type, source, subject_matter, action_unit, status, remark, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
