...
if(isset($_POST['record_category_btn']))
{
    ...
    $categ_query = "INSERT INTO record_category (route_number, record_type, source, subject_matter, action_unit, status, remark, image)
    VALUES ('$route_number', '$record_type', '$source', '$subject_matter', '$action_unit', '$status', '$remark','$filename')";
