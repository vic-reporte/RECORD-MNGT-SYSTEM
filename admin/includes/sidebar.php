...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "index-dashboard.php"? 'active bg-gradient-primary':''; ?>" href="index-dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "record.php"? 'active bg-gradient-primary':''; ?>" href="record.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">All Record</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "add-record.php"? 'active bg-gradient-primary':''; ?>" href="add-record.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "logs.php"? 'active bg-gradient-primary':''; ?>" href="logs.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-symbols-outlined">groups</i>
            </div>
        ...
        <!--li class="nav-item">
          <a class="nav-link text-white " href="Backup&Restore.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
